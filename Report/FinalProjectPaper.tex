...
\subsubsection{find\textit{1}In\textit{N}Elements}
\begin{algorithmic}
...
\medskip
\subsubsection{count\textit{5}sIn\textit{N}Elements}
\begin{algorithmic}
...
\medskip
\subsubsection{count\textit{5}sInRandom\textit{N}Elements}
\begin{algorithmic}
...
\medskip
\subsubsection{count\textit{5}sInSparse\textit{N}Elements}
