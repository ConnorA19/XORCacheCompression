...
The cache-line size is fixed at 64\,B across the hierarchy. this default setup ensures that all observed effect results solely from the compression
mechanism.
...
conventional pattern-based compressors such as BDI or BVC. Compression latency
